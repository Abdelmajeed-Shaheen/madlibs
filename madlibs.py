...
def main():
	...
	print("I opened the door and there was a box full of "+items+" with a note saying \"From Mr. "+capwords(name)+".\"")
	print("Just as I closed the door I heard a scream \""+scream.upper()+"\".")
	print("I froze in place and all I could do was "+action+" my head.")
